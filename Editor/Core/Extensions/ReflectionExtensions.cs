...
namespace LordSheo.Editor
{
	public static class ReflectionExtensions
	{
		...
		{
			return ReflectionUtil.FindFieldInfo(type, type, name, flags);
		}
		...
		public static FieldInfo FindFieldInfo(this object obj, string name)
		{
			...
			return ReflectionUtil.FindFieldInfo(type, type, name, INSTANCE_FLAGS);
		}

		public static FieldInfo FindFieldInfo_Static(this Type type, string name)
		{
			return ReflectionUtil.FindFieldInfo(type, type, name, STATIC_FLAGS);
		}
		...
		{
			return ReflectionUtil.FindPropertyInfo(type, type, name, flags);
		}
		...
		public static PropertyInfo FindPropertyInfo(this object obj, string name)
		{
			...
			return ReflectionUtil.FindPropertyInfo(type, type, name, INSTANCE_FLAGS);
		}

		public static PropertyInfo FindPropertyInfo_Static(this Type type, string name)
		{
			return ReflectionUtil.FindPropertyInfo(type, type, name, STATIC_FLAGS);
		}
		...
		{
			return ReflectionUtil.FindMethodInfo(type, type, name, args, flags);
		}
		...
		public static MethodInfo FindMethodInfo(this object obj, string name, params Type[] args)
		{
			...
			return ReflectionUtil.FindMethodInfo(type, type, name, args, INSTANCE_FLAGS);
		}

		public static MethodInfo FindMethodInfo_Static(this Type type, string name, params Type[] args)
		{
			return ReflectionUtil.FindMethodInfo(type, type, name, args, STATIC_FLAGS);
		}
		public static MethodInfo FindMethodInfo_Static(this Type type, string name)
		{
			return ReflectionUtil.FindMethodInfo(type, type, name, STATIC_FLAGS);
		}
		...
		{
			return ReflectionUtil.FindMethodInfo(type, type, name, INSTANCE_FLAGS);
		}
